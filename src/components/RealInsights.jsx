  ...
  return (
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-16 lg:gap-x-40">
          {/* Image */}
          ...
          <div className="lg:w-1/2 mt-10 lg:mt-10">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-light text-gray-800 mb-6 text-left">
              Real Insights by Alpha Mead
            </h2>
            
            <p className="text-gray-600 text-lg lg:text-xl font-medium mb-10 leading-relaxed text-left">
