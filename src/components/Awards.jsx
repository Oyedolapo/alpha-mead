...
const Awards = () => {
    return (
        <div>
            <h2 className="text-3xl md:text-4xl font-light text-gray-800 mb-6">Awards & Recognition</h2>
            <div className="space-y-6">
                ...
                <div className="space-y-6">
                    <div>
                        <h3 className="text-lg md:text-xl font-bold text-gray-800 mb-4 border-b pb-2">Some of the Milestones achieved during the years:</h3>
                        
                        <h4 className="text-lg font-bold text-gray-800 mt-6 mb-4">AWARDS</h4>
                        ...
                        <h4 className="text-lg font-bold text-gray-800 mt-6 mb-4">ACCREDITATIONS</h4>
