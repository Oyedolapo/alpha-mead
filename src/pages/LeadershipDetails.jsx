...
const LeaderDetails = () => {
  ...
  return (
    <>
      ...
      <section className="min-h-screen bg-gray-50 py-16 px-6 md:px-12 lg:px-20 font-roboto pt-[10rem] md:pt-[11rem] lg:pt-[12rem]">
        {/* Back Button */}
        <button
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          {/* Leader Info */}
          <div className="bg-white p-6 sm:p-8 md:p-10 lg:p-12 rounded-3xl shadow-md">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-3">
              {leader.name}
            </h1>
            <h2 className="text-sm sm:text-lg md:text-xl font-medium text-green-700 mb-6">
              {leader.title}
            </h2>
